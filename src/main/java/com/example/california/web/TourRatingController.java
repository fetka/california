package com.example.california.web;

import com.example.california.domain.Tour;
import com.example.california.domain.TourRating;
import com.example.california.domain.TourRatingPk;
import com.example.california.repo.TourRatingRepository;
...
public class TourRatingController {
    ...
    private Tour verifyTour(int tourId) throws NoSuchElementException {
        return (Tour) tourRepository.findById(tourId).orElseThrow(() ->
